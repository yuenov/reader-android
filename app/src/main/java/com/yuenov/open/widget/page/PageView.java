...
import com.yuenov.open.widget.page.animation.CoverPageAnim;
import com.yuenov.open.widget.page.animation.HorizonPageAnim;
import com.yuenov.open.widget.page.animation.NonePageAnim;
import com.yuenov.open.widget.page.animation.PageAnimation;
import com.yuenov.open.widget.page.animation.ScrollPageAnim;
import com.yuenov.open.widget.page.animation.SimulationPageAnim;
import com.yuenov.open.widget.page.animation.SlidePageAnim;
...
public class PageView extends View {
     ...
     * @return
     */
    public PageLoader getPageLoader(BookBaseInfo bookBaseInfo, long chapterId) {
        // 判是否已经存在
        if (mPageLoader != null) {
            return mPageLoader;
        }

        mPageLoader = new PageLoader(this, bookBaseInfo, chapterId);
